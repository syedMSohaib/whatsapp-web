...
var app = new Vue({
	...
	created: function created() {
		...
		Echo.private('conversation').listen('MessageSent', function (e) {
			console.log(e);
		});
	},
	...
	methods: {
		fetchMessages: function fetchMessages() {
			...
			var conversationId = localStorage.getItem('conversation-id');
  ...
  return _c(
    ...
    _vm._l(_vm.messages, function(message) {
      return _c("li", { staticClass: "left clearfix" }, [
        message.fromMe
          ? _c("div", { staticClass: "chat-body clearfix text-right" }, [
              _c("p", [
                _vm._v("\n        " + _vm._s(message.body) + "\n      ")
              ])
            ])
          : !message.fromMe
          ? _c("div", { staticClass: "chat-body clearfix pull-right" }, [
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    handleMedia: function handleMedia(e) {
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "input-group" }, [
      ...
      _c(
        "button",
        {
          ...
          on: {
            click: function($event) {
              return _vm.$refs.imageselector.click()
            }
          }
        },
        [_vm._v("\r\n      Image\r\n    ")]
    ...
    _c("div", { staticClass: "bottom row" }, [
      _vm.image ? _c("p", [_vm._v(_vm._s(_vm.image.name))]) : _vm._e(),
      _vm._v(" "),
      _c("br"),
      _vm._v(" "),
      _vm.file ? _c("p", [_vm._v(_vm._s(_vm.file.name))]) : _vm._e()
    ])
  ])
}
var staticRenderFns = []
